...
export namespace Core
{
    ...
    public:
        ...
        [[nodiscard]] virtual std::optional<DomainEntity> get_by_id(std::int32_t id) const = 0;
        ...
        virtual std::expected<void, DbError> delete_by_id(std::int32_t id) = 0;

        [[nodiscard]] virtual bool exists_by_id(std::int32_t id) const = 0;
